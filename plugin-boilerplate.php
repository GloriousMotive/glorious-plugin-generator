...
/**
 * Plugin Name:       Plugin Boilerplate Generator for GloriousMotive
 * Plugin URI:       https://github.com/gloriousmotive/
 ...
 * Author URI:       https://nirajkashyap.com
...
class PluginBoilerplate {
    ...
    public function __construct() {
        $this->github_download_url = 'https://github.com/GloriousMotive/WordPress-Plugin-Boilerplate/archive/refs/heads/master.zip';
    ...
    public function init_menu() {
        add_submenu_page( 'tools.php', __( 'Plugin Generator', 'plugin-boilerplate' ), __( 'Plugin Generator', 'plugin-boilerplate' ), 'manage_options', 'plugin-boilerplate', array( $this, 'admin_page' ) );
    }
